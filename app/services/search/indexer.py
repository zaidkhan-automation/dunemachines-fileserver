...
def get_qdrant() -> AsyncQdrantClient:
    # Whether an API key is required for this URL is enforced once, at
    # process startup, in app/core/config.py (hard RuntimeError, not a
    # warning here — confirmed via live netstat that this exact
    # public-URL-no-key config is genuinely reachable, not just
    # theoretically risky). By the time this function ever runs, that
